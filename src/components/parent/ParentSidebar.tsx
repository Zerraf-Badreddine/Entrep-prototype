...
import { LayoutDashboard, Users, MessageSquare, Calendar, Settings, X } from 'lucide-react';
...
const menuItems = {
  ...
  ar: [
    ...
    { id: 'children', icon: Users, label: 'أطفالي' },
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white opacity-80">Espace Parent</p>
            </div>
          </div>
...
export function ParentSidebar({ activeView, setActiveView, language, isOpen, setIsOpen }: ParentSidebarProps) {
